...
class Renderer
{
    private:
        ...
        RenderConfig buildRenderConfig(const Scene &scene) const;
        ...
        Image renderTiled(const Scene &scene, const Camera &camera, Sfml *sfml, const RenderConfig &config) const;
    public:
        Renderer() = default;
        ~Renderer() = default;
